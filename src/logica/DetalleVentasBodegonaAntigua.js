...
async function consultarVentasSucursal(sucursal, fechaInicio, fechaFin) {
    try {
        ...
        // Consulta SQL para ventas Bodegona Antigua
        const query = `
            SELECT
...
async function exportarExcel() {
    ...
    try {
        ...
        workbook.creator = 'Sistema de Ventas Bodegona Antigua';
        ...
        a.href = url;
        a.download = `VentasBodegonaAntigua_${fechaInicio}_a_${fechaFin}.xlsx`;
